...
export const apiUrfShow = (id) => customFetch(`${URF}/${id}`, 'GET', {});
...
export const apiUrfQueue = () => customFetch(`${URF}/queue`, 'GET', {});

export const apiUrfReportWindows = () => customFetch(`${URF}/report-windows`, 'GET', {});
