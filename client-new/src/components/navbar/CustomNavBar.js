...
export const buttonConfig = [
    ...
    { path: '/projects', icon: <i class="fa fa-briefcase" aria-hidden="true"></i>, text: 'Projects', roles: ['faculty', 'hod', 'phd_coordinator', 'dordc', 'adordc', 'dra', 'director', 'admin'], feature: 'job_openings' },
