  ...
  return (
    <div className="faculty-container">
      ...
      <div className="faculty-info-grid">
        ...
        <div style={{ gridColumn: '1 / -1' }}><strong>Area of Expertise:</strong> {Array.isArray(faculty.expertise) && faculty.expertise.length ? faculty.expertise.join(', ') : faculty.expertise || "—"}</div>
      </div>
