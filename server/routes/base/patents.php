...
Route::get('/student/{studentId}', [PatentsController::class, 'getForStudent'])->middleware('auth:sanctum');
Route::delete('/{id}', [PatentsController::class, 'destroy'])->middleware('auth:sanctum');