import { SupervisorChangeForm, User, Student } from '../../../models/index.js';
...
export const listForm = async (req, res) => {
  try {
    const forms = await SupervisorChangeForm.findAll({
...
export const createForm = async (req, res) => {
  try {
    ...
    const form = await SupervisorChangeForm.create({
