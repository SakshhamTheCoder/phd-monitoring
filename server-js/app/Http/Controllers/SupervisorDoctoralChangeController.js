import { SupervisorDoctoralChange, User, Student } from '../../../models/index.js';
...
export const listForm = async (req, res) => {
  try {
    const forms = await SupervisorDoctoralChange.findAll({
...
export const createForm = async (req, res) => {
  try {
    ...
    const form = await SupervisorDoctoralChange.create({
...
export const loadForm = async (req, res) => {
  try {
    ...
    const form = await SupervisorDoctoralChange.findByPk(form_id, {
      include: [{ model: Student, as: 'student', include: ['user', 'department'] }]
    });
...
export const submit = async (req, res) => {
  try {
    ...
    // TODO: Implement complete role-specific submission logic
