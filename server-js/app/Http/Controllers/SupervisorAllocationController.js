import { SupervisorAllocation, User, Student } from '../../../models/index.js';
...
export const listForm = async (req, res) => {
  try {
    const forms = await SupervisorAllocation.findAll({
...
export const createForm = async (req, res) => {
  try {
    ...
    const form = await SupervisorAllocation.create({
...
export const loadForm = async (req, res) => {
  try {
    ...
    const form = await SupervisorAllocation.findByPk(form_id, {
      include: [{ model: Student, as: 'student', include: ['user', 'department'] }]
    });
